...
ContextInspector::ContextInspector(QWidget *parent) : QWidget(parent)
{
...
void ContextInspector::showContext(const QJsonArray &items)
{
...
void ContextInspector::showRawRequest(const QJsonObject &request)
{
