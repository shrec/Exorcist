...
ChatSessionHistoryPopup::ChatSessionHistoryPopup(QWidget *parent)
    : QWidget(parent)
{
...
void ChatSessionHistoryPopup::setSessions(const QList<SessionEntry> &sessions)
{
    m_sessions = sessions;
    rebuildList();
}

void ChatSessionHistoryPopup::showAt(const QPoint &globalPos)
{
    move(globalPos);
    show();
...
void ChatSessionHistoryPopup::rebuildList()
{
    m_list->clear();
...
void ChatSessionHistoryPopup::filterList()
{
    rebuildList();
}
