...
ChatWorkspaceEditWidget::ChatWorkspaceEditWidget(QWidget *parent)
    : QWidget(parent)
{
...
void ChatWorkspaceEditWidget::setEditedFiles(const QVector<ChatContentPart::EditedFile> &files)
{
...
QWidget *ChatWorkspaceEditWidget::createFileRow(const ChatContentPart::EditedFile &file, int index)
{
...
QString ChatWorkspaceEditWidget::buttonStyle(const QString &bg, const QString &fg, const QString &hover)
{
...
QString ChatWorkspaceEditWidget::smallButtonStyle()
{
    return QStringLiteral(
...
QString ChatWorkspaceEditWidget::formatDiffHtml(const QString &diffText)
{
