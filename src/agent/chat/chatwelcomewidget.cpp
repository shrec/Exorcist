...
bool PillClickFilter::eventFilter(QObject *obj, QEvent *ev)
{
...
ChatWelcomeWidget::ChatWelcomeWidget(QWidget *parent)
    : QWidget(parent)
{
...
void ChatWelcomeWidget::showState(State state)
{
    clearLayout();
...
void ChatWelcomeWidget::clearLayout()
{
...
void ChatWelcomeWidget::buildDefaultWelcome(bool disabled)
{
    m_layout->addStretch();
