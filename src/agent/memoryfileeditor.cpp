...
MemoryFileEditor::MemoryFileEditor(QWidget *parent) : QWidget(parent)
{
...
void MemoryFileEditor::setMemoryRoot(const QString &root)
{
    m_memoryRoot = root;
    refresh();
}

void MemoryFileEditor::refresh()
{
    m_fileList->clear();
...
void MemoryFileEditor::createFile()
{
...
void MemoryFileEditor::deleteFile()
{
...
void MemoryFileEditor::saveFile()
{
    auto *item = m_fileList->currentItem();
    if (!item) return;
    const QString path = item->data(Qt::UserRole).toString();
...
void MemoryFileEditor::loadFile(const QString &path)
{
    QFile file(path);
...
void MemoryFileEditor::scanDir(const QDir &dir, const QString &prefix)
{
