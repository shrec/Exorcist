...
{
public:
    explicit CreateDashboardMissionTool(AgentUIBus *bus) : m_bus(bus) {}
...
{
public:
    explicit UpdateDashboardStepTool(AgentUIBus *bus) : m_bus(bus) {}
...
{
public:
    explicit UpdateDashboardMetricTool(AgentUIBus *bus) : m_bus(bus) {}
...
{
public:
    explicit AddDashboardLogTool(AgentUIBus *bus) : m_bus(bus) {}
...
{
public:
    explicit AddDashboardArtifactTool(AgentUIBus *bus) : m_bus(bus) {}
...
{
public:
    explicit CompleteDashboardMissionTool(AgentUIBus *bus) : m_bus(bus) {}
