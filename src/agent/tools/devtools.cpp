...
ToolSpec CompileAndRunTool::spec() const
{
    ToolSpec s;
...
ToolExecResult CompileAndRunTool::invoke(const QJsonObject &args)
{
...
QString CompileAndRunTool::detectCompiler()
{
...
ToolSpec ArchiveTool::spec() const
{
    ToolSpec s;
...
ToolExecResult ArchiveTool::invoke(const QJsonObject &args)
{
...
ToolExecResult ArchiveTool::listArchive(const QString &path, const QString &fmt)
{
    QProcess proc;
...
ToolExecResult ArchiveTool::extractArchive(const QString &path, const QString &fmt,
...
ToolExecResult ArchiveTool::createArchive(const QString &path, const QString &fmt,
...
QString ArchiveTool::detectFormat(const QString &path, const QString &hint)
{
...
QString ArchiveTool::resolvePath(const QString &path) const
{
...
ToolSpec CreatePatchTool::spec() const
{
    ToolSpec s;
...
ToolExecResult CreatePatchTool::invoke(const QJsonObject &args)
{
    const QString op = args[QLatin1String("operation")].toString();
...
ToolExecResult CreatePatchTool::diffFiles(const QJsonObject &args)
{
...
ToolExecResult CreatePatchTool::diffContent(const QJsonObject &args)
{
...
ToolExecResult CreatePatchTool::gitPatch(const QJsonObject &args)
{
...
QString CreatePatchTool::resolvePath(const QString &path) const
{
    if (path.isEmpty() || QFileInfo(path).isAbsolute() || m_workspaceRoot.isEmpty())
        return path;
    return QDir(m_workspaceRoot).absoluteFilePath(path);
...
ToolSpec ImageInfoTool::spec() const
{
    ToolSpec s;
...
ToolExecResult ImageInfoTool::invoke(const QJsonObject &args)
{
...
QString ImageInfoTool::resolvePath(const QString &path) const
{
    if (path.isEmpty() || QFileInfo(path).isAbsolute() || m_workspaceRoot.isEmpty())
        return path;
    return QDir(m_workspaceRoot).absoluteFilePath(path);
...
GenerateDiagramTool::GenerateDiagramTool(DiagramRenderer renderer)
    : m_renderer(std::move(renderer))
{
}

ToolSpec GenerateDiagramTool::spec() const
{
    ToolSpec s;
...
ToolExecResult GenerateDiagramTool::invoke(const QJsonObject &args)
{
...
QString GenerateDiagramTool::resolvePath(const QString &path) const
{
    if (path.isEmpty() || QFileInfo(path).isAbsolute() || m_workspaceRoot.isEmpty())
        return path;
    return QDir(m_workspaceRoot).absoluteFilePath(path);
...
TreeSitterParseTool::TreeSitterParseTool(TreeSitterParser parser)
    : m_parser(std::move(parser))
{
}

ToolSpec TreeSitterParseTool::spec() const
{
    ToolSpec s;
...
ToolExecResult TreeSitterParseTool::invoke(const QJsonObject &args)
{
    const QString code     = args[QLatin1String("code")].toString();
...
PerformanceProfileTool::PerformanceProfileTool(Profiler profiler)
    : m_profiler(std::move(profiler))
{
}

ToolSpec PerformanceProfileTool::spec() const
{
    ToolSpec s;
...
ToolExecResult PerformanceProfileTool::invoke(const QJsonObject &args)
{
...
SymbolDocTool::SymbolDocTool(DocGetter getter)
    : m_getter(std::move(getter))
{
}

ToolSpec SymbolDocTool::spec() const
{
    ToolSpec s;
...
ToolExecResult SymbolDocTool::invoke(const QJsonObject &args)
{
...
CodeCompletionTool::CodeCompletionTool(CompletionGetter getter)
    : m_getter(std::move(getter))
{
}

ToolSpec CodeCompletionTool::spec() const
{
    ToolSpec s;
...
ToolExecResult CodeCompletionTool::invoke(const QJsonObject &args)
{
    const QString filePath    = args[QLatin1String("filePath")].toString();
    const int line            = args[QLatin1String("line")].toInt();
    const int column          = args[QLatin1String("column")].toInt();
