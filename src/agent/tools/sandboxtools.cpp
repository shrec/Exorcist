...
ToolSpec JsonParseFormatTool::spec() const
{
    ToolSpec s;
...
ToolExecResult JsonParseFormatTool::invoke(const QJsonObject &args)
{
...
ToolSpec CurrentTimeTool::spec() const
{
    ToolSpec s;
...
ToolExecResult CurrentTimeTool::invoke(const QJsonObject &args)
{
...
ToolSpec RegexTestTool::spec() const
{
    ToolSpec s;
...
ToolExecResult RegexTestTool::invoke(const QJsonObject &args)
{
    const QString op      = args[QLatin1String("operation")].toString();
...
QString RegexTestTool::formatMatch(const QRegularExpressionMatch &m)
{
...
ToolSpec EnvironmentVariablesTool::spec() const
{
    ToolSpec s;
...
ToolExecResult EnvironmentVariablesTool::invoke(const QJsonObject &args)
{
    const QString op = args[QLatin1String("operation")].toString();
...
ToolSpec FileHashTool::spec() const
{
    ToolSpec s;
...
ToolExecResult FileHashTool::invoke(const QJsonObject &args)
{
...
QString FileHashTool::resolvePath(const QString &path) const
{
...
ToolSpec WorkspaceConfigTool::spec() const
{
    ToolSpec s;
...
ToolExecResult WorkspaceConfigTool::invoke(const QJsonObject &args)
{
...
ToolExecResult WorkspaceConfigTool::scanConfigs() const
{
...
ToolExecResult WorkspaceConfigTool::readConfig(const QString &file) const
{
    if (file.isEmpty())
