...
GetDiagnosticsTool::GetDiagnosticsTool(DiagnosticsGetter getter)
    : m_getter(std::move(getter)) {}

ToolSpec GetDiagnosticsTool::spec() const
{
    ToolSpec s;
...
ToolExecResult GetDiagnosticsTool::invoke(const QJsonObject &args)
{
...
GitStatusTool::GitStatusTool(GitStatusGetter getter)
    : m_getter(std::move(getter)) {}

ToolSpec GitStatusTool::spec() const
{
    ToolSpec s;
...
ToolExecResult GitStatusTool::invoke(const QJsonObject &)
{
...
GitDiffTool::GitDiffTool(GitDiffGetter getter)
    : m_getter(std::move(getter)) {}

ToolSpec GitDiffTool::spec() const
{
    ToolSpec s;
...
ToolExecResult GitDiffTool::invoke(const QJsonObject &args)
{
    const QString filePath = args[QLatin1String("filePath")].toString();
