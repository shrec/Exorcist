...
DebugSetBreakpointTool::DebugSetBreakpointTool(BreakpointSetter setter,
                                               BreakpointRemover remover)
    : m_setter(std::move(setter)), m_remover(std::move(remover))
{
}

ToolSpec DebugSetBreakpointTool::spec() const
{
    ToolSpec s;
...
ToolExecResult DebugSetBreakpointTool::invoke(const QJsonObject &args)
{
...
DebugGetStackTraceTool::DebugGetStackTraceTool(StackGetter getter)
    : m_getter(std::move(getter))
{
}

ToolSpec DebugGetStackTraceTool::spec() const
{
    ToolSpec s;
...
ToolExecResult DebugGetStackTraceTool::invoke(const QJsonObject &args)
{
...
DebugGetVariablesTool::DebugGetVariablesTool(VariablesGetter getter,
                                             Evaluator evaluator)
    : m_getter(std::move(getter)), m_evaluator(std::move(evaluator))
{
}

ToolSpec DebugGetVariablesTool::spec() const
{
    ToolSpec s;
...
ToolExecResult DebugGetVariablesTool::invoke(const QJsonObject &args)
{
...
DebugStepTool::DebugStepTool(Stepper stepper)
    : m_stepper(std::move(stepper))
{
}

ToolSpec DebugStepTool::spec() const
{
    ToolSpec s;
...
ToolExecResult DebugStepTool::invoke(const QJsonObject &args)
{
