...
ToolSpec ReplaceStringTool::spec() const
{
    QJsonObject props;
...
ToolExecResult ReplaceStringTool::invoke(const QJsonObject &args)
{
...
GetErrorsTool::GetErrorsTool(DiagnosticsGetter getter)
    : m_getter(std::move(getter)) {}

ToolSpec GetErrorsTool::spec() const
{
    ToolSpec s;
...
ToolExecResult GetErrorsTool::invoke(const QJsonObject &)
{
...
GetChangedFilesTool::GetChangedFilesTool(StatusGetter getter)
    : m_getter(std::move(getter)) {}

ToolSpec GetChangedFilesTool::spec() const
{
    ToolSpec s;
...
ToolExecResult GetChangedFilesTool::invoke(const QJsonObject &)
{
...
ToolSpec FetchWebpageTool::spec() const
{
    QJsonObject props;
...
ToolExecResult FetchWebpageTool::invoke(const QJsonObject &args)
{
