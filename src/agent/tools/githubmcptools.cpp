...
ToolSpec GitHubIssuesTool::spec() const
{
    ToolSpec s;
...
ToolExecResult GitHubIssuesTool::invoke(const QJsonObject &args)
{
...
ToolSpec GitHubPRTool::spec() const
{
    ToolSpec s;
...
ToolExecResult GitHubPRTool::invoke(const QJsonObject &args)
{
    const QString owner = args.value(QStringLiteral("owner")).toString();
    const QString repo = args.value(QStringLiteral("repo")).toString();
...
ToolSpec GitHubCodeSearchTool::spec() const
{
    ToolSpec s;
...
ToolExecResult GitHubCodeSearchTool::invoke(const QJsonObject &args)
{
...
ToolSpec GitHubRepoInfoTool::spec() const
{
    ToolSpec s;
...
ToolExecResult GitHubRepoInfoTool::invoke(const QJsonObject &args)
{
    const QString owner = args.value(QStringLiteral("owner")).toString();
    const QString repo = args.value(QStringLiteral("repo")).toString();
