...
public:
    explicit SetupTestsWizard(QObject *parent = nullptr) : QObject(parent) {}

    struct SetupStep {
        QString title;
        QString description;
        QString command;           // terminal command to run
        QString fileToCreate;      // file path to create
        QString fileContent;       // content for the file
    };

    // Generate setup steps for detected project type
    ...
    // Build AI prompt for test setup guidance
