...
APIKeyManagerWidget::APIKeyManagerWidget(QWidget *parent) : QWidget(parent)
{
...
void APIKeyManagerWidget::setProviders(const QStringList &providers, const QMap<QString, bool> &hasKey)
{
...
void APIKeyManagerWidget::saveKey()
{
...
void APIKeyManagerWidget::removeKey()
{
...
void APIKeyManagerWidget::testConnection()
{
    auto *item = m_providerList->currentItem();
    if (!item) return;
    const QString provider = item->data(Qt::UserRole).toString();
