...
// ── CppLanguageIndexer ───────────────────────────────────────────────────────
// Extracts C++ classes, methods, includes, namespaces, Qt connections,
// ServiceRegistry calls, and QTest test cases.

class CppLanguageIndexer : public ILanguageIndexer
{
public:
